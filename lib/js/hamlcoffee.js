      ...
      if (tokens.doctype) {
        ...
        if (this.isNotSelfClosing(tokens.tag)) {
          ...
          if (tokens.assignment) {
            ...
            assignment = match[2];
            if (identifier === '~') {
              code = "\#{$fp this." + assignment + " }";
            } else if (identifier === '&=' || (identifier === '=' && this.escapeHtml)) {
              if (this.preserve) {
                if (this.cleanValue) {
                  code = "\#{ $p($e($c(this." + assignment + "))) }";
                } else {
                  code = "\#{ $p($e(this." + assignment + ")) }";
                }
              } else {
                if (this.cleanValue) {
                  code = "\#{ $e($c(this." + assignment + ")) }";
                } else {
                  code = "\#{ $e(this." + assignment + ") }";
                }
              }
            } else if (identifier === '!=' || (identifier === '=' && !this.escapeHtml)) {
              if (this.preserve) {
                if (this.cleanValue) {
                  code = "\#{ $p($c(this." + assignment + ")) }";
                } else {
                  code = "\#{ $p(this." + assignment + ") }";
                }
              } else {
                if (this.cleanValue) {
                  code = "\#{ $c(this." + assignment + ") }";
                } else {
